...
class SentAffiliationScreen extends StatefulWidget {
  const SentAffiliationScreen({Key? key}) : super(key: key);

  @override
  _SentAffiliationScreenState createState() => _SentAffiliationScreenState();
}

class _SentAffiliationScreenState extends State<SentAffiliationScreen> {
  ...
  getSentAction() async{
    SentConnection resp = await bloc.getSentConnection();
    if (resp.data!=null) {
      mList.clear();
